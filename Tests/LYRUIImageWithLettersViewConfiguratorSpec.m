...
SpecBegin(LYRUIImageWithLettersViewConfigurator)

describe(@"LYRUIImageWithLettersViewConfigurator", ^{
    __block LYRUIImageWithLettersViewConfigurator *configurator;
    ...
    beforeEach(^{
        ...
        configurator = [[LYRUIImageWithLettersViewConfigurator alloc] initWithImageFetcher:imageFetcherMock
    ...
    describe(@"setupImageWithLettersView:withIdentity:", ^{
        ...
        context(@"when identity contains avatar url", ^{
            ...
            context(@"and initials formatter returned initials for the identity", ^{
                beforeEach(^{
                    [configurator setupImageWithLettersView:viewMock withIdentity:identityMock];
                });
