...
describe(@"LYRUIIdentityListViewConfiguration", ^{
    describe(@"setupIdentityListView:", ^{
        ...
        beforeEach(^{
            ...
            [given([configurationMock configurationForViewClass:[LYRUIIdentityItemView class]]) willReturn:itemViewConfigurationMock];
            ...
            [given([configurationMock layoutForViewClass:[LYRUIIdentityListView class]]) willReturn:layoutMock];
