//
//  LYRUIListSupplementaryViewConfiguring.h
//  Layer-UI-iOS
//
...
@protocol LYRUIListSupplementaryViewConfiguring <NSObject>
...
/**
 @abstract Kind of the collection reusable view handled by the configuration.
 */
@property (nonatomic, readonly) NSString *viewKind;

/**
 @abstract Reuse identifier of the collection reusable view used by the configuration to present model data.
 */
@property (nonatomic, readonly) NSString *viewReuseIdentifier;

/**
 @abstract Method used to register reusable view of kind handled by the configuration, for reuse identifier in the collection view.
