...
@protocol LYRUIListHeaderView <NSObject>
...
@protocol LYRUIListHeaderViewLayout <LYRUIViewLayout>
...
@interface LYRUIListHeaderView : UICollectionReusableView <LYRUIListHeaderView>

@property (nonatomic, copy) id<LYRUIListHeaderViewLayout> layout;
