//
//  LYRUIPresenceViewConfiguration.h
//  Layer-UI-iOS
//
...
/**
 @abstract The `LYRUIPresenceViewConfiguration` sets the `LYRUIPresenceView` with the data from provided `identities` array, with use of view theme.
 */
@interface LYRUIPresenceViewConfiguration : NSObject
