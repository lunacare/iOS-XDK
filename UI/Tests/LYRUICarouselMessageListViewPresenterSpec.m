...
#import <LayerXDK/LYRUICarouselMessageListLayout.h>
...
#import <LayerXDK/LYRUICarouselListDelegate.h>

@interface LYRUIMessageListView (Tests)
@property (nonatomic, strong, readwrite) UICollectionView *collectionView;
@end

SpecBegin(LYRUICarouselMessageListViewPresenter)

describe(@"LYRUICarouselMessageListViewPresenter", ^{
    __block LYRUICarouselMessageListViewPresenter *presenter;
    __block LYRUIConfiguration *configurationMock;
    __block id<LYRUIDependencyInjection> injectorMock;
    __block LYRUICarouselMessageListLayout *layoutMock;
    ...
    __block LYRUICarouselListDelegate *delegateMock;
    __block LYRUICarouselMessageListView *view;
    ...
    beforeEach(^{
        ...
        layoutMock = mock([LYRUICarouselMessageListLayout class]);
        [[given([layoutMock copyWithZone:NSDefaultMallocZone()]) withMatcher:anything()] willReturn:layoutMock];
        [given([injectorMock layoutForViewClass:[LYRUICarouselMessageListView class]]) willReturn:layoutMock];
        
        cellPresenterMock = mock([LYRUICarouselItemCellPresenter class]);
        [given([injectorMock objectOfType:[LYRUICarouselItemCellPresenter class]]) willReturn:cellPresenterMock];
        ...
        delegateMock = mock([LYRUICarouselListDelegate class]);
        [given([injectorMock objectOfType:[LYRUICarouselListDelegate class]]) willReturn:delegateMock];
        
        presenter = [[LYRUICarouselMessageListViewPresenter alloc] initWithConfiguration:configurationMock];
        
        view = [[LYRUICarouselMessageListView alloc] init];
