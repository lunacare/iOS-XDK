//
//  LYRUILargeFeedbackMessageContainerViewPresenter.m
//  Layer-XDK-UI-iOS
//
//  Created by Klemen Verdnik on 7/31/18.
...
@interface LYRUILargeFeedbackMessageContainerViewPresenter ()

@property (nonatomic, strong, readwrite, nullable) LYRUITitledMessageContainerViewPresenter *titlePresenter;

@end

@implementation LYRUILargeFeedbackMessageContainerViewPresenter
