//
//  LYRUILargeMediaMessageContentViewPresenter.m
//  Layer-XDK-UI-iOS
//
//  Created by Klemen Verdnik on 7/9/18.
...
@implementation LYRUILargeMediaMessageContentViewPresenter
...
- (void)setupViewConstraints:(UIView *)view forImageSize:(CGSize)size {
    ...
    [view.heightAnchor constraintLessThanOrEqualToConstant:size.height].active = YES;
}
