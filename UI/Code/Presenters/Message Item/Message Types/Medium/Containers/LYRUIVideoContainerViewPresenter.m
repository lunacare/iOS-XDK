//
//  LYRUIVideoContainerViewPresenter.m
//  Layer-XDK-UI-iOS
//
...
@implementation LYRUIVideoContainerViewPresenter

+ (Class<LYRUIMessageViewContainer, LYRUIStandardMessageContainerViewTheme, LYRUIConfigurable>)containerViewClass
{
    return [LYRUIVideoMessageContainerView class];
}

- (LYRUIMediaMessageContainerView *)viewForMessage:(LYRUIMediaMessage *)message {
    LYRUIMediaMessageContainerView *view = (LYRUIMediaMessageContainerView *)[super viewForMessage:message];
    view.mediaControlButton.enabled = NO;
    return view;
}
