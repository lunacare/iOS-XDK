...
+ (void)prepareIdentityListForInterfaceBuilder:(LYRUIIdentityListView *)identityList {
    ...
    LYRUIIdentityItemViewPresenter *identityItemViewPresenter = [[LYRUIIdentityItemViewPresenter alloc] init];
    LYRUIListCellPresenter *cellPresenter =
        [[LYRUIListCellPresenter alloc] initWithCellClass:[LYRUIIdentityCollectionViewCell class]
                                                   modelClass:[LYRIdentity class]
                                            viewPresenter:identityItemViewPresenter
                                                   cellHeight:height
