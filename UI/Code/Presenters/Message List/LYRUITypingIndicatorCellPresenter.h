//
//  LYRUITypingIndicatorCellPresenter.h
//  Layer-XDK-UI-iOS
//
...
@interface LYRUITypingIndicatorCellPresenter : NSObject <LYRUIListCellSizeCalculating, LYRUIListCellPresenting, LYRUIConfigurable>
@end
