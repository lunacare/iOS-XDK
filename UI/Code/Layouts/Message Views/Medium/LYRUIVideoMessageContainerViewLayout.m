//
//  LYRUIVideoMessageContainerViewLayout.m
//  Layer-XDK-UI-iOS
//
...
@implementation LYRUIVideoMessageContainerViewLayout
...
- (NSArray<NSLayoutConstraint *> *)playButtonConstraintsForView:(LYRUIMediaMessageContainerView *)view {
    ...
    [constraints addObject:[view.mediaControlButton.centerXAnchor constraintEqualToAnchor:view.contentViewContainer.centerXAnchor]];
    [constraints addObject:[view.mediaControlButton.centerYAnchor constraintEqualToAnchor:view.contentViewContainer.centerYAnchor]];
