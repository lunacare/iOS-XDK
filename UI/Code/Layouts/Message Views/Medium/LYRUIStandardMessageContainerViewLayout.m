...
- (void)addConstantConstraintsInView:(LYRUIStandardMessageContainerView *)view {
    ...
    [constraints addObjectsFromArray:[self contentViewConstraintsForView:view]];
    [constraints addObjectsFromArray:[self metadataContainerConstraintsForView:view]];
    ...
    [constraints addObjectsFromArray:[self additionalConstraintsForView:view]];
...
- (NSArray<NSLayoutConstraint *> *)metadataContainerConstraintsForView:(LYRUIStandardMessageContainerView *)view {
    ...
    return @[ [view.metadataContainer.topAnchor constraintEqualToAnchor:view.contentViewContainer.bottomAnchor],
              ...
              [view.metadataContainer.bottomAnchor constraintEqualToAnchor:view.bottomAnchor] ];
}
